...
int main(){
// faire une condition sur chois, si c'est une lettre ce'est ff
int choix;
if (scanf(" %c", &choix) != 1) {
...
int main() {
    ...
    printf("Entrez un chiffre entre 1 et 4 pour choisir ce que vous voulez faire\n\n1- Pour Détecter les obstacles présents sur une image.\n2- Pour vous déplacer sur une image sans objets.\n3- Pour sélectionner une image et vous déplacer dessus.\n4- Pour quitter\n");
    if (scanf(" %c", &choix) != 1) {
